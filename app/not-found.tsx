  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center">
      ...
      <div className="relative">
        ...
        <div className="mono text-[12px] uppercase tracking-widest text-signal">{t.t("ui", "notFoundKicker")}</div>
        <h1 className="mt-3 text-3xl font-semibold text-ink">{t.t("ui", "notFoundTitle")}</h1>
