...
export type AgencyClientView = Omit<
  AgencyClient,
  "billingMode" | "monthlyPriceCents" | "currency"
> &
  Partial<Pick<AgencyClient, "billingMode" | "monthlyPriceCents" | "currency">>;
...
export interface AgencyFindingShare {
  id: string;
  agencyId: string;
  clientId: string;
...
export interface AgencyBulkJob {
  id: string;
  agencyId: string;
  type: "scan" | "report" | "digest";
  status: string;
...
export interface AgencyReport {
  ...
  periodStart: string;
  periodEnd: string;
  kind: "client" | "portfolio" | "executive";
  status: string;
  title: string;
...
export interface AgencySlaEvent {
  id: string;
  clientId: string;
  findingId: string;
...
export interface AgencyNotificationRouting {
  emails: string[];
  channelIds: string[];
...
export interface PortfolioOverview {
  ...
  slaBreaches: number;
  recentChanges: Array<
    GuardianEvent & { clientOrgId: string; clientName: string }
  >;
  topRecommendations: Array<
    GuardianRecommendation & { clientOrgId: string; clientName: string }
  >;
