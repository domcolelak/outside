...
import enEvolution from "@/messages/en/evolution.json";
...
import skUi from "@/messages/sk/ui.json";
import skEnterprise from "@/messages/sk/enterprise.json";
import skEvolution from "@/messages/sk/evolution.json";
...
import csUi from "@/messages/cs/ui.json";
import csEnterprise from "@/messages/cs/enterprise.json";
import csEvolution from "@/messages/cs/evolution.json";
...
import huUi from "@/messages/hu/ui.json";
import huEnterprise from "@/messages/hu/enterprise.json";
import huEvolution from "@/messages/hu/evolution.json";
...
import plUi from "@/messages/pl/ui.json";
import plEnterprise from "@/messages/pl/enterprise.json";
import plEvolution from "@/messages/pl/evolution.json";

/** Namespaces are separate files so no locale becomes one unreviewable blob. */
const BUNDLES = {
  en: { common: enCommon, navigation: enNavigation, landing: enLanding, auth: enAuth, email: enEmail, report: enReport, support: enSupport, finding: enFinding, account: enAccount, billing: enBilling, guardian: enGuardian, assess: enAssess, chronos: enChronos, integrations: enIntegrations, capabilities: enCapabilities, agency: enAgency, scan: enScan, ui: enUi, enterprise: enEnterprise, evolution: enEvolution },
  sk: { common: skCommon, navigation: skNavigation, landing: skLanding, auth: skAuth, email: skEmail, report: skReport, support: skSupport, finding: skFinding, account: skAccount, billing: skBilling, guardian: skGuardian, assess: skAssess, chronos: skChronos, integrations: skIntegrations, capabilities: skCapabilities, agency: skAgency, scan: skScan, ui: skUi, enterprise: skEnterprise, evolution: skEvolution },
  cs: { common: csCommon, navigation: csNavigation, landing: csLanding, auth: csAuth, email: csEmail, report: csReport, support: csSupport, finding: csFinding, account: csAccount, billing: csBilling, guardian: csGuardian, assess: csAssess, chronos: csChronos, integrations: csIntegrations, capabilities: csCapabilities, agency: csAgency, scan: csScan, ui: csUi, enterprise: csEnterprise, evolution: csEvolution },
  hu: { common: huCommon, navigation: huNavigation, landing: huLanding, auth: huAuth, email: huEmail, report: huReport, support: huSupport, finding: huFinding, account: huAccount, billing: huBilling, guardian: huGuardian, assess: huAssess, chronos: huChronos, integrations: huIntegrations, capabilities: huCapabilities, agency: huAgency, scan: huScan, ui: huUi, enterprise: huEnterprise, evolution: huEvolution },
  pl: { common: plCommon, navigation: plNavigation, landing: plLanding, auth: plAuth, email: plEmail, report: plReport, support: plSupport, finding: plFinding, account: plAccount, billing: plBilling, guardian: plGuardian, assess: plAssess, chronos: plChronos, integrations: plIntegrations, capabilities: plCapabilities, agency: plAgency, scan: plScan, ui: plUi, enterprise: plEnterprise, evolution: plEvolution },
} as const;
